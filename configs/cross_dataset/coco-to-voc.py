_base_ = [
    '../_base_/models/otseg.py', '../_base_/datasets/voc12_20_aug_512x512.py',
...
model = dict(
    ...
    test_cfg=dict(mode='slide', crop_size=(img_size, img_size), stride=(380, 380)), 
    ...
    exclude_key='prompt',
    multi_prompts=True,
    load_text_embedding="Path/to/configs/_base_/datasets/text_embedding/coco_otseg.npy"
)
